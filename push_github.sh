...
curl --request POST --url 127.0.0.1:5000/hooks/github/ --header 'X-GitHub-Event: push' --header 'X-GitHub-Delivery:'  --data '{
  ...
  "repository": {
    ...
    "ssh_url": "git@github.com:QianqianQ/course-templates.git",
    "clone_url": "https://github.com/QianqianQ/course-templates.git",
